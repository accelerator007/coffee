...
export default function KPICard({ label, value, icon: IconComp, color = 'text-accent' }: Props) {
  return (
    <div className="bg-surface border border-border rounded-3xl p-4 flex flex-col gap-2 shadow-[0_2px_12px_rgba(111,78,55,0.07)]">
      <div className="flex items-center justify-between">
        ...
        <span className="w-9 h-9 flex items-center justify-center rounded-2xl bg-muted text-brand">
          <IconComp size={18} strokeWidth={1.75} aria-hidden />
        </span>
      </div>
